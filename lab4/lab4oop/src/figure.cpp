...
void Line::draw_figure(){
    gfx_color(rand()%256,rand()%256,rand()%256);
    gfx_line(points[0].get_x(),points[0].get_y(),points[1].get_x(),points[1].get_y());
}
...
void Triangle::draw_figure(){
    gfx_color(rand()%256,rand()%256,rand()%256);
    gfx_line(points[0].get_x(),points[0].get_y(),points[1].get_x(),points[1].get_y());
    gfx_line(points[1].get_x(),points[1].get_y(),points[2].get_x(),points[2].get_y());
    gfx_line(points[2].get_x(),points[2].get_y(),points[0].get_x(),points[0].get_y());
}
...
void Rectangle::draw_figure(){
    gfx_color(rand()%256,rand()%256,rand()%256);
    gfx_line(points[0].get_x(),points[0].get_y(),points[1].get_x(),points[1].get_y());
    gfx_line(points[1].get_x(),points[1].get_y(),points[2].get_x(),points[2].get_y());
    gfx_line(points[2].get_x(),points[2].get_y(),points[3].get_x(),points[3].get_y());
    gfx_line(points[3].get_x(),points[3].get_y(),points[0].get_x(),points[0].get_y());
}
...
void Circle::draw_figure(){
    gfx_color(rand()%256,rand()%256,rand()%256);
    float a = (M_PI / 180);
    int j = 1;
    for(float i = a; i < 2*M_PI; j++, i = a * j){
        gfx_point((cos(i)* r) + center.get_x(),(sin(i)* r) + center.get_y());
    }
}
...
void Ellipse::draw_figure(){
    gfx_color(rand()%256,rand()%256,rand()%256);
    for(int i = 0; i < 359; i++){
        gfx_point(points[i].get_x(),points[i].get_y());
    }
}